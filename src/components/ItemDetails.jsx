  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div
          className={`flex-1 flex flex-col justify-center px-8 py-20 md:px-16 lg:px-24 transition-all duration-1000 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}
        >
          <div className="max-w-xl">
            ...
            <div className="grid grid-cols-2 gap-8 mb-12 border-t border-gray-100 pt-12">
              <div className="space-y-2">
                <h4 className="text-[10px] font-black uppercase tracking-widest text-[#FF5C00]">
                  Select Sold Level
                </h4>
            ...
            <div className="bg-gray-50 rounded-[2.5rem] p-8 md:p-10 mb-8 border border-gray-100">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="space-y-1 text-center md:text-left">
                  ...
                  <p className="font-oswald text-4xl text-gray-900 font-black">
                    Rs. {item.price}
                  </p>
                </div>
