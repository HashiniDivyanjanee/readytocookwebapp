...
export const About = ({ fullPage }) => {
  return (
    <section id="about" className={`bg-white overflow-hidden ${fullPage ? '' : 'py-16 md:py-32'}`}>
      {/* Page Banner */}
      {fullPage && (
        <div className="relative h-[50vh] min-h-[400px] w-full flex items-center justify-center overflow-hidden bg-black">
          ...
          <div className="relative z-10 text-center space-y-4">
            <span className="text-[#FF5C00] font-oswald text-xs tracking-[0.6em] uppercase font-black block animate-[fadeIn_1s_ease-out]">The Grill House</span>
            ...
            <p className="text-white/80 font-playfair italic text-lg md:text-2xl animate-[fadeIn_1.5s_ease-out]">A legacy of wood, smoke, and fire</p>
          </div>
        </div>
      )}
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center mb-16 md:mb-24">
          <div className="space-y-6 md:space-y-8 text-center md:text-left">
            <div className="space-y-2">
              <span className="text-[#FF5C00] font-oswald text-base md:text-lg tracking-widest uppercase font-bold">Discover our story</span>
              <h2 className="font-oswald text-3xl md:text-6xl text-gray-900 leading-[0.9] uppercase font-bold">
                Traditional <br className="hidden md:block" /> <span className="text-[#FF5C00]">& Family Recipes</span>
              </h2>
            </div>
          ...
          <div className="relative h-[350px] sm:h-[450px] md:h-[550px] mt-8 md:mt-0">
            <div className="absolute top-0 right-0 w-[85%] aspect-square bg-[#1a110a] rounded-[30px] md:rounded-[40px] shadow-2xl overflow-hidden transform rotate-3 animate-float">
               <img src="https://images.unsplash.com/photo-1541544741938-0af808871cc0?q=80&w=800&auto=format&fit=crop" alt="Traditional Grill" className="w-full h-full object-cover opacity-80" />
            </div>
            <div className="absolute -bottom-6 left-0 w-[70%] aspect-square bg-[#8B0000] rounded-[30px] md:rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden transform -rotate-6 z-10 border-[8px] md:border-[12px] border-white animate-float" style={{ animationDelay: '1s' }}>
               <img src="https://images.unsplash.com/photo-1532550907401-a500c9a57435?q=80&w=800&auto=format&fit=crop" alt="Smoky Chicken" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
