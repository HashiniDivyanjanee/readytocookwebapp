...
export const TESTIMONIALS = [
  {
    ...
    name: 'Nelum Avishka',
    role: 'Customer',
    content: 'The ribs were absolutely falling off the bone! Best BBQ experience I have had in years. Highly recommended for families.',
    rating: 5,
    image: 'https://i.pravatar.cc/150?u=nelum'
  },
  {
    id: 2,
    name: 'Saman Perera',
    role: 'Food Blogger',
    content: 'The BBQ shrimp here is the best in the city. Perfectly seasoned and the ambiance is incredible! A must-visit spot.',
    rating: 5,
